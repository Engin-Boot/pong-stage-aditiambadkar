...
3. b. - If the player clicks on "Existing Player" option from the main menu
...
5. a. If the player clicks on "Easy" option, the pong ball direction randomness
...
5. b. If the player clicks on "Medium" option, the pong ball direction randomness
...
5. c. If the player clicks on "Hard" option, the pong ball direction randomness
